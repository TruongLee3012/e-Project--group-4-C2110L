                            ...
                            <div class="service-card">
                                <div class="row">
                                    <div class="thumbnail col col-md-3">
                                        <img style="width: 100%; height: 100%" src="../../images/services/2.jpg" alt="">
                                    </div>
                                    <div class="card-items col col-md-9">
                                        ...
                                        <div class="card-content">
                                            <div class="treatment-type">
                                                <p>Fixed bridge
                                                    <p>Implant-supported bridge
                                                        <p>Resin-bonded bridge
                                                            <p>Cantilever bridge
                                            </div>
                    ...
                    <div>
                        <a href="dental_implant.html">
                            <div class="service-card">
                                <div class="row">
                                    <div class="thumbnail col col-md-3">
                                        <img style="width: 100%;" src="../../images/services/3.jpg" alt="">
                                    </div>
                                    <div class="card-items col col-md-9">
                                        <div class="card-title">
                                        ...
                                        <div class="card-content">
                                            <div class="treatment-type">
                                                <p> Implant-supported single tooth
                                                    <p> Implant-supported bridge
                                                        <p> Implant-supported dentures
                                                            <p> Implant-supported row
                                            </div>
                                            <div class="treatment-price">
                                                <p> $50 to $300
                                                    <p> $90 to $450
                    ...
                    <div>
                        <a href="filling.html">
                            <div class="service-card">
                                <div class="row">
                                    <div class="thumbnail col col-md-3">
                                        <img style="width: 100%;" src="../../images/services/6.jpg" alt="">
                                    </div>
                                    <div class="card-items col col-md-9 ">
                                        <div class="card-title">
                                            <h3>Filling</h3>
